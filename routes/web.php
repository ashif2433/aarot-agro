...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('about')->name('about.')->group(function () {
        Route::get('{section}', [AboutController::class, 'index'])->name('index');
        Route::get('{section}/create', [AboutController::class, 'create'])->name('create');
        Route::post('{section}', [AboutController::class, 'store'])->name('store');
        Route::get('{section}/{about}/edit', [AboutController::class, 'edit'])->name('edit');
        Route::put('{section}/{about}', [AboutController::class, 'update'])->name('update');
        Route::delete('{section}/{about}', [AboutController::class, 'destroy'])->name('destroy');
    });

});

Route::get('/about-us', [AboutPageController::class, 'index'])->name('about.frontend');
...
Route::post('/summernote/upload', [UploadController::class, 'summernoteUpload'])->name('summernote.upload');
