...
@section('content')
    ...
    <div class="banner-bootom-w3-agileits">
        <div class="container">
            ...
            <div class="row"
                ...
                <div class="col-md-5 single-right-left simpleCart_shelfItem">
                    ...
                    @endisset
                    <div class="">
                        <p class="mt-1">Wholesale order :</p>
                        <p class="mt-1 pb-3">Mohammad Kanchan Miah - +8801724284888</p>
                        <p class="mt-1">Exporter Details :</p>
                        <p class="mt-1 pb-3">Shibalaya Manikgonj -1850 78 Motijheel ( 8th floor) C/A Dhaka-1000.</p>
                        <p class="mt-1">Name : Mohammad Kanchan Miah</p>
                        <p class="mt-1">Export Of Bangladesh</p>
                        <p class="mt-1">Buy kG : Start 4 KG</p>
                        <p class="mt-1">Buy Canned Food : Available Size</p>
                    </div>
                    ...
                    <p style="font-size: 13px">
                        <span
                            style="background: green;color: white;border-radius: 50%;width: 20px;height: 20px;display: inline-block;font-size: 13px;line-height: 20px;text-align: center;"><i
                                class="icofont icofont-tick-mark"></i></span> In Stock
                        {{-- style="background: green;color: white;border-radius: 50%;width: 20px;height: 20px;display: inline-block;font-size: 13px;line-height: 20px;text-align: center;"><i
                                ...
                                @foreach ($colors_product as $color)
                                    <label class="btn   p-3 m-1 color {{ $product->colors->count() == 1 ? 'active' : '' }}"
                                        ...
                                        @if ($product->images)
                                            ...
                                            @endforeach
                                        @endif
                                        <input type="radio" name="color" autocomplete="off" value="{{ $color->slug }}"
                ...
                <div style="margin-top: 10px;font-size: 12px;">
                    <div class="dropdown row single-product-button" style="padding-bottom: 10px;margin: 0;">
                    ...
                    <a href="https://wa.me/{{ setting('whatsapp') }}" class="btn btn-primary">Whatsapp Us:
                        {{ setting('whatsapp') }}</a>
        ...
        <div class="products related row"
            style="background: rgb(250, 249, 249);box-shadow: 0px 4px 6px -3px #9c9c9c;margin-right: -15px;;margin-left: -15px;">
            <div class="container">
