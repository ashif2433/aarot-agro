...
<header class="not-home">
    <div class="upper-header d-none" style="">
        <div class="container">
    ...
    <div class="top-header header_area" style="background:#1a4724">
            ...
            <div class="search-box" id="search-box-open">
                <form action="{{ route('product.search') }}" method="GET">
                    <div class="input-group">
                        <input readonly placeholder="Search Product...." class="sear" type="search" name="keyword">
                        <!--<input readonly placeholder="Search Product...." class="sear" type="search"-->
