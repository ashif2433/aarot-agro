...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="row">
            <form class="col-sm-12" action="{{ isset($product) ? routeHelper('product/'.$product->id) : routeHelper('product') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @isset($product)
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6 d-none">
                            ...
                            <input step="0.01" type="number" name="whole_price" id="whole_price" placeholder="Enter product whole sell price" class="form-control @error('whole_price') is-invalid @enderror" value="1000">
                        ...
                        <div class="form-group col-md-6 d-none">
                            ...
                            <input step="0.01" type="number" name="regular_price" id="regular_price" placeholder="Enter product regular price" class="form-control @error('regular_price') is-invalid @enderror" value="1000">
                        ...
                        <div class="form-group col-md-6 d-none">
                            ...
                            <input type="number" name="point" id="point" placeholder="Enter product point" class="form-control @error('point') is-invalid @enderror" value="100" >
                        ...
                        <div class="form-group col-md-6 d-none">
                            ...
                            <input type="number" name="quantity" id="quantity" placeholder="Enter product quantity" class="form-control @error('quantity') is-invalid @enderror" value="1000">
